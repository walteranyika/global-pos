      ...
      public function Update_payment_gateway(Request $request)
      {
       ...
       public function sms_config(Request $request)
       {
           $this->authorizeForUser($request->user('api'), 'update', Setting::class);
             ...
             $this->setEnvironmentValue([
                 'TWILIO_SID' => $request['TWILIO_SID'] !== null?$request['TWILIO_SID']:'',
                 'TWILIO_TOKEN' => $request['TWILIO_TOKEN'] !== null?$request['TWILIO_TOKEN']:'',
                 'TWILIO_FROM' => $request['TWILIO_FROM'] !== null?$request['TWILIO_FROM']:'',
             ]);
