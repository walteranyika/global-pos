              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    <td>{{$t('OrderTax')}}</td>
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(sale_return.TaxNet,2)}} ({{formatNumber(sale_return.tax_rate,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td>{{$t('Discount')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(sale_return.discount,2)}}</td>
                  </tr>
                  <tr>
                    <td>{{$t('Shipping')}}</td>
                    <td>{{currentUser.currency}} {{formatNumber(sale_return.shipping,2)}}</td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{currentUser.currency}} {{formatNumber(sale_return.GrandTotal ,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(sale_return.paid_amount,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(sale_return.due,2)}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
