          ...
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        >
                          ...
                          <td>{{currentUser.currency}} {{formatNumber(detail.subtotal, 2)}}</td>
                          <td>
                            <a
                ...
                <b-col md="12">
                  <b-form-group>
                    <b-button variant="primary" @click="Submit_Sale_return">{{$t('submit')}}</b-button>
                  </b-form-group>
                </b-col>
              </b-row>
            </b-card>
