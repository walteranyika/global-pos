          ...
          <b-col lg="12" md="12" sm="12">
            <b-card>
              <b-row>
                  ...
                  <table class="table table-striped table-sm">
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span>{{currentUser.currency}} {{formatNumber(purchase.TaxNet ,2)}} ({{formatNumber(purchase.tax_rate ,2)}} %)</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Discount')}}</td>
                        <td>{{currentUser.currency}} {{formatNumber(purchase.discount ,2)}}</td>
                      </tr>
                      <tr>
                        <td class="bold">{{$t('Shipping')}}</td>
                        <td>{{currentUser.currency}} {{formatNumber(purchase.shipping ,2)}}</td>
                      </tr>
                      <tr>
                        <td>
                ...
                <b-col md="12">
                  <b-form-group>
                    <b-button variant="primary" @click="Submit_Purchase">{{$t('submit')}}</b-button>
                  </b-form-group>
                </b-col>
              </b-row>
            </b-card>
