              ...
              <table class="table table-striped table-sm">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(purchase_return.TaxNet ,2)}} ({{formatNumber(purchase_return.tax_rate,2)}} %)</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(purchase_return.discount,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span>{{currentUser.currency}} {{formatNumber(purchase_return.shipping,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      ...
                      >{{currentUser.currency}} {{formatNumber(purchase_return.GrandTotal,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(purchase_return.paid_amount,2)}}</span>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <span
                        class="font-weight-bold"
                      >{{currentUser.currency}} {{formatNumber(purchase_return.due ,2)}}</span>
                    </td>
                  </tr>
                </tbody>
              </table>
